...
For the spec:view task, you can specify a controller, and an action. If you just
specify a controller, all the actions for that view will run.

You can run thor spec:list --help to list all the available types.
